    ...
    <div style={{ minHeight: "100vh", background: "#f5f5f5", display: "flex", flexDirection: "column" }}>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .up-logo-text { font-size: 18px; font-weight: 600; }
        .up-email { font-size: 13px; color: #ccc; }
        .up-right { display: flex; align-items: center; gap: 12px; }
        .up-body { display: flex; flex: 1; position: relative; }
        ...
        /* Fixed red line issue by using a standard class toggle */
        .up-overlay.open { display: block; }

        .up-main { flex: 1; min-width: 0; padding: 28px 24px; }
        .up-inner { max-width: 960px; margin: 0 auto; width: 100%; }
      ...
      <div className="up-body">
        {/* BUG FIX: Changed to template string here to avoid red line in CSS section above */}
      ...
      <footer style={{ background: "#4a3728", color: "#ccc", padding: "24px 32px", fontSize: "13px" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "8px" }}>
          <div>
            <div style={{ fontWeight: "700", fontSize: "16px", color: "#e6a817", marginBottom: "4px" }}>
          ...
          <div style={{ borderTop:"1px solid rgba(255,255,255,0.1)", marginTop:"12px", paddingTop:"10px", fontSize:"12px", opacity:0.6 }}>
            © 2026 myMetro University Portal · All rights reserved
          </div>
        </div>
      </footer>
    </div>
